 ...
 * ============================
 *public class Receiver : IMessagePassingComm          --receives CommMessages and Files from Senders
...
*public int size()                                     --get number of messages in queue
*public void close()                                   --close ServiceHost
*public bool openFileForWrite(string name)             --called by Sender's proxy to open file on Receiver
*public bool writeFileBlock(byte[] block)              --write a block received from Sender instance
*public void closeFile()                               --close Receiver's uploaded file
...
*public bool connect(string toAddress)                 --attempts to connect to Receiver instance
*public class Comm                                     --Comm class combines Receiver and Sender
*public void close()                                   --shutdown comm
*public bool restart(int newport)                      --restart comm
*public void closeConnection()                         --closes connection but keeps comm alive
* 
 * Maintenance History:
 * --------------------
 * ver 1.0 : 05 Dec 2018
